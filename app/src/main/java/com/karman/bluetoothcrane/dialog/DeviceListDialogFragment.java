...
//        project_id = bundle.getInt (AppConfigTags.PROJECT_ID);
    ...
    private void initData() {
        ...
        deviceAdapter.SetOnItemClickListener(new DeviceAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                onDialogResultListener.onPositiveResult(deviceList.get(position).getBluetoothDevice(), deviceList.get(position).getName(), deviceList.get(position).getAddress());
                getDialog().dismiss();
            }
        });
            ...
            public void afterTextChanged(Editable s) {
                ...
                if (s.toString().length() > 0) {
                    ...
                    deviceAdapter.SetOnItemClickListener(new DeviceAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, int position) {
                            Utils.hideSoftKeyboard(getActivity());
                            onDialogResultListener.onPositiveResult(deviceListTemp.get(position).getBluetoothDevice(),deviceListTemp.get(position).getName(), deviceListTemp.get(position).getAddress());
                            getDialog().dismiss();
                        }
                    });
        ...
        try {
            ...
            if (bondedDevices.isEmpty()) {
                ...
                for (BluetoothDevice iterator : bondedDevices) {
                    deviceList.add(new Device(iterator, iterator.getName(), iterator.getAddress(), "PAIRED",false));
                }
            }
    ...
    public interface OnDialogResultListener {
        public abstract void onPositiveResult(BluetoothDevice bluetoothDevice, String name, String address);
     ...
     private BroadcastReceiver btReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            if (BluetoothDevice.ACTION_FOUND.equals(action)) {
                ...
                deviceList.add(new Device(device, device.getName(), device.getAddress(), "NOT PAIRED", false));
                deviceAdapter.notifyDataSetChanged();
            }
        }
    };
